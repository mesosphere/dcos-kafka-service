...
def uninstall(package_name, service_name, role=None, service_account=None, zk=None):
    _uninstall(package_name, service_name, role, service_account, zk)


def _uninstall(package_name, service_name, role=None, service_account=None, zk=None):
    start = time.time()
    ...
    if sdk_utils.dcos_version_less_than("1.10"):
        ...
        try:
            ...
            log.info(
                "Got exception when uninstalling package, "
